...
inline
void
multiply(field& f, std::size_t len, const char* src, char* dst, std::uint32_t coefficient)
{
...
inline
void
multiply_add(field& f, std::size_t len, const char* src, char* dst, std::uint32_t coefficient)
{
